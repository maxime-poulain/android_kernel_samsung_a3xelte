...
ARCH		= arm64
CROSS_COMPILE = /home/khaon/android/linaro-5.3/bin/aarch64-linux-android-
...
KBUILD_CFLAGS   := -O3 -mcpu=cortex-a53 -mtune=cortex-a53 \
...
KBUILD_AFLAGS   := -D__ASSEMBLY__ -O3 -mcpu=cortex-a53 -mtune=cortex-a53
