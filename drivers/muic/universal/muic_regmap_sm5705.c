...
#define _COM_UART_CP		COM_VALUE(_D_UART_CP)
...
static int sm5705_set_manual_JIGON(struct regmap_desc *pdesc, int jig_attached)
{
	int attr = 0, value = 0, ret = 0;
...
static void sm5705_get_formatted_dump(struct regmap_desc *pdesc, char *mesg)
{
...
static struct regmap_ops sm5705_muic_regmap_ops = {
	...
	.get_formatted_dump = sm5705_get_formatted_dump,
};
...
static struct vendor_ops sm5705_muic_vendor_ops = {
	...
	.set_manual_JIGON = sm5705_set_manual_JIGON,
