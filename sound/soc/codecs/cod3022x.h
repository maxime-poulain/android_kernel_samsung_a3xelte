...
extern int cod3022x_jack_mic_register(struct snd_soc_codec *codec);

#define COD3022X_OTP_MAX_REG		0x0F
#define COD3022X_MAX_REGISTER		0xfe
#define COD3022X_OTP_REG_WRITE_START	0xd0
#define COD3022X_OTP_REG_READ_START	0xf0

#define COD3022X_BTN_RELEASED_MASK	BIT(0)
#define COD3022X_BTN_PRESSED_MASK	BIT(1)

struct cod3022x_jack_det {
	bool jack_det;
	bool mic_det;
	bool button_det;
...
struct cod3022x_priv {
	...
	bool	is_suspend;
	struct cod3022x_jack_det jack_det;
	...
	unsigned char otp_reg[COD3022X_OTP_MAX_REG];
...
#define COD3022X_01_IRQ1PEND                    0x01
#define COD3022X_02_IRQ2PEND                    0x02
#define COD3022X_03_IRQ3PEND                    0x03
#define COD3022X_04_IRQ4PEND                    0x04
...
/* OTP Read only registers */
#define COD3022X_F0_CTRL_IREF1			0xf0
#define COD3022X_F4_OFFSET_DAL			0xf4
#define COD3022X_F5_OFFSET_DAR			0xf5
#define COD3022X_F6_CTRL_IREF5			0xf6
#define COD3022X_F8_CTRL_CP2			0xf8
#define COD3022X_FB_CTRL_HPS			0xfb
#define COD3022X_FC_CTRL_EPS			0xfc
#define COD3022X_FE_CTRL_SPKS2			0xfe

/* COD3022X_01_IRQ1PEND */
...
#define VOLAD1_CTVOL_BST1_MASK	MASK(VOLAD1_CTVOL_BST1_WIDTH, \
...
#define VOLAD2_CTVOL_BST2_MASK	MASK(VOLAD2_CTVOL_BST2_WIDTH, \
...
#define VOLAD3_CTVOL_LNL_WIDTH		3

#define VOLAD3_CTVOL_LNR_SHIFT		0
#define VOLAD3_CTVOL_LNR_WIDTH		3
